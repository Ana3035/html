/*
 * @Author: Ana
 * @Date: 2021-11-19 18:17:39
 * @LastEditors: Ana
 * @LastEditTime: 2021-11-19 20:44:48
 * @Description: 今天也要加油呀
 * @FilePath: /史努比/style.js
 */
...
function fly(){
    setInterval(function(){
        ...
        if(ball.offsetTop>=670-50 || ball.offsetTop<=0)
        speedy *=-1
        if(ball.offsetLeft>=1000-50 || ball.offsetLeft<=0)
        speedx *= -1
    },50)
}
